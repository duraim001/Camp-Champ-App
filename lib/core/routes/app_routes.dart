...
import '../../features/admin/presentation/screens/faculty_requests_screen.dart';
...
import '../../features/authentication/presentation/screens/faculty_registration_screen.dart';
...
abstract class AppRoutes {
  ...
  static const String adminFacultyRequests = '/admin-faculty-requests';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case facultyRegistration:
        page = const FacultyRegistrationScreen();
        break;
      case parentLogin:
      ...
      case adminDashboard:
        ...
        break;
      case adminFacultyRequests:
        if (!SessionManager().canAccessAdminRoutes()) {
          page = const AccessDeniedScreen();
        } else {
          page = const FacultyRequestsScreen();
        }
        break;
